...
class BatchedSeqLen:
    ...
    def copy_from_tensor(self, lens_tensor: torch.Tensor):
        ...
        """
        assert lens_tensor.device == self.device, f"Device mismatch: {lens_tensor.device} vs {self.device}"
...
class BatchedSeqLenDelta:
    ...
    def copy_from_tensor(self, old_len_tensor: torch.Tensor, new_len_tensor: torch.Tensor):
